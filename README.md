...
* **사전 팀 구성 기간 :** `01-02-2023 ~ 30-02-2023`  
* **프로젝트 진행 기간 :** `01-03-2023 ~ 30-06-2023`
* **팀 구성 인원 :**
  * **최건우 [Leader / Dev] – 영상 편집, 보고서 작성, 비용 감사, 코드 작성**
  * 제작 2명 – 제작 재료 구매, 회로 설계, 
  * 회계 1명 – 비용 관리, 회의 장소 대관 관리
...
* 본 프로젝트의 진행을 위한 지원금 집행은 총 500,000원으로 책정 되었으며, 이는 향후 3개월간 사용 과정과 증빙이 필요하여 결제 내역을 함께 첨부하여 관리 해왔습니다.
* 2022년 규정과 상반되는 신규 규정이 생겨남으로써 지원금 집행의 비율을 계획해야 함으로, 해당 프로젝트의 개발비 325,000원인 65%와 기타 비용 (회의비) 175,000원으로 35% 비율 수립으로 향후 소모품의 금액 변동성이 발생 가능성에 따라 주최측과 담당 교수와의 면담 이후 조율을 진행했습니다.
